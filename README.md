Database Setup The project uses a SQLite database (hawaii.sqlite). The database contains two tables: Measurement and Station. These tables are reflected using SQLAlchemy.
